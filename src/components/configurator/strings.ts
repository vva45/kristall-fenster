...
export const S = {
  ...
  technicalNotice: {
    en: "No automatic price: Kamika checks feasibility and prepares the binding quote.",
    de: "Kein automatischer Preis: Kamika prüft die Machbarkeit und erstellt das verbindliche Angebot.",
    pl: "Bez automatycznej ceny: Kamika sprawdza wykonalność i przygotowuje wiążącą ofertę.",
  },
  previewNotice: { en: "Illustrative only — proportions, colours and details are not binding.", de: "Nur orientativ – Proportionen, Farben und Details sind unverbindlich.", pl: "Wyłącznie orientacyjnie — proporcje, kolory i detale nie są wiążące." },
  configurationReview: { en: "Configuration check", de: "Konfigurationsprüfung", pl: "Sprawdzenie konfiguracji" },
  errorsLabel: { en: "Errors", de: "Fehler", pl: "Błędy" },
  warningsLabel: { en: "Technical review", de: "Technische Prüfung", pl: "Weryfikacja techniczna" },
  fixErrors: { en: "Correct the incompatible options before adding this configuration.", de: "Bitte korrigieren Sie die unvereinbaren Optionen, bevor Sie diese Konfiguration hinzufügen.", pl: "Popraw niezgodne opcje przed dodaniem konfiguracji." },
  reviewStatus: { en: "Review", de: "Prüfung", pl: "Weryfikacja" },
  reviewRequired: { en: "This selection requires individual technical review.", de: "Diese Auswahl erfordert eine individuelle technische Prüfung.", pl: "Ten wybór wymaga indywidualnej weryfikacji technicznej." },
  reviewStandard: { en: "No known conflicts; final technical confirmation still applies.", de: "Keine bekannten Konflikte; die abschließende technische Bestätigung bleibt erforderlich.", pl: "Brak znanych konfliktów; nadal wymagana jest końcowa weryfikacja techniczna." },
  ...
  stepProgress: { en: "Step {current} of {count}", de: "Schritt {current} von {count}", pl: "Krok {current} z {count}" },
